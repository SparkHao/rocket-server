use diesel::{SqliteConnection, QueryResult, query_dsl::methods::{LimitDsl, FindDsl, OrderDsl, SelectDsl}, RunQueryDsl, ExpressionMethods};
use crate::{Product, schema::products, NewProduct};
